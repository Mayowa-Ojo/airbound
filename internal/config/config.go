...
type Config struct {
	...
	AWSSQSAccessKeyID           string        `envconfig:"AWS_SQS_ACCESS_KEY_ID"`
	AWSSQSSecretAccessKey       string        `envconfig:"AWS_SQS_SECRET_ACCESS_KEY"`
	AWSSQSReservationsQueueARN  string        `envconfig:"AWS_SQS_RESERVATIONS_QUEUE_ARN"`
	AWSSQSReservationsQueueURL  string        `envconfig:"AWS_SQS_RESERVATIONS_QUEUE_URL"`
	AWSSQSReservationsQueueName string        `envconfig:"AWS_SQS_RESERVATIONS_QUEUE_NAME"`
	AWSSQSDelay                 int           `envconfig:"AWS_SQS_DELAY"`
	AWSSQSVisibility            int           `envconfig:"AWS_SQS_VISIBILITY"`
